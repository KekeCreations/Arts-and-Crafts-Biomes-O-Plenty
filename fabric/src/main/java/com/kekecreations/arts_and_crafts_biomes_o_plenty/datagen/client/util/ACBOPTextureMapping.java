...
public class ACBOPTextureMapping {
    ...
    public static ResourceLocation getPlantTexture(String plant, String modID) {
        return ResourceLocation.fromNamespaceAndPath(modID, "block/" + plant);
    }

    public static ResourceLocation getFlowerPotTexture(DyeColor colour) {
        return ResourceLocation.fromNamespaceAndPath("arts_and_crafts", "block/" + colour.getName() + "_flower_pot");
    }
}
